...
import br.com.alura.forumhub.dto.DtoDetalhamentoUsuario;
...
public class UsuarioController {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity<?> cadastrar(@RequestBody @Valid DtoCadastroUsuario dados,
    ...
    @GetMapping("/me")
    public ResponseEntity<DtoDetalhamentoUsuario> detalharUsuarioLogado(
