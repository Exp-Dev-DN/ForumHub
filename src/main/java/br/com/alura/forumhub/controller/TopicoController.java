...
import br.com.alura.forumhub.dto.DtoDetalhamentoTopico;
import br.com.alura.forumhub.dto.DtoListagemTopico;
...
public class TopicoController {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity cadastrar(@RequestBody @Valid DtoCadastroTopico dados, UriComponentsBuilder uriBuilder) {
    ...
    @GetMapping
    public ResponseEntity<Page<DtoListagemTopico>> listar(
        ...
        var page = repository.findAll(spec, paginacao).map(DtoListagemTopico::new);
    ...
    @PutMapping("/{id}")
    @Transactional
    public ResponseEntity<DtoDetalhamentoTopico> atualizar(
            @PathVariable Long id,
            @RequestBody @Valid DtoAtualizacaoTopico dados,
