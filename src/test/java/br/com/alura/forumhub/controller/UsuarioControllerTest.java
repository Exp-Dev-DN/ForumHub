...
import br.com.alura.forumhub.dto.DtoCadastroUsuario;
...
public class UsuarioControllerTest {
    ...
    @Autowired
    private JacksonTester<DtoCadastroUsuario> dadosCadastroJson;
    ...
    void cadastrar_cenario1() throws Exception {
        var dadosCadastro = new DtoCadastroUsuario("novo.usuario@email.com", "senhaForte123");
        ...
        assertThat(passwordEncoder.matches("senhaForte123", usuarioSalvo.getPassword())).isTrue();
    }
    ...
    void cadastrar_cenario2() throws Exception {
        ...
        var dadosCadastroDuplicado = new DtoCadastroUsuario("usuario.existente@email.com", "outraSenha");
