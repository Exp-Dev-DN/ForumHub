...
import br.com.alura.forumhub.dto.DtoAtualizacaoResposta;
import br.com.alura.forumhub.dto.DtoCadastroResposta;
...
class RespostaControllerTest {
    ...
    @Autowired
    private JacksonTester<DtoCadastroResposta> dadosCadastroRespostaJson;

    @Autowired
    private JacksonTester<DtoAtualizacaoResposta> dadosAtualizacaoRespostaJson;
    ...
    void criarResposta_cenario1() throws Exception {
        var dados = new DtoCadastroResposta("Esta é uma resposta de teste.");
    ...
    void criarResposta_cenario2() throws Exception {
        var dados = new DtoCadastroResposta("Resposta para tópico que não existe.");
    ...
    void criarResposta_cenario3() throws Exception {
        var dados = new DtoCadastroResposta("Nova resposta criada com sucesso!");
    ...
    void atualizarResposta_cenario1() throws Exception {
        ...
        var dadosAtualizacao = new DtoAtualizacaoResposta("Mensagem atualizada!");
    ...
    void atualizarResposta_cenario2() throws Exception {
        ...
        var resposta = respostaRepository.save(new Resposta(null, "Mensagem original", this.topico, LocalDateTime.now(), autorResposta, false));
        var dadosAtualizacao = new DtoAtualizacaoResposta("Tentativa de invasão");
