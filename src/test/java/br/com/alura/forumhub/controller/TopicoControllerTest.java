...
import br.com.alura.forumhub.dto.DtoAtualizacaoTopico;
import br.com.alura.forumhub.dto.DtoCadastroTopico;
...
class TopicoControllerTest {
    ...
    @Autowired
    private JacksonTester<DtoCadastroTopico> dadosCadastroJson;

    @Autowired
    private JacksonTester<DtoAtualizacaoTopico> dadosAtualizacaoJson;
    ...
    void cadastrar_cenario2() throws Exception {
        var dadosCadastro = new DtoCadastroTopico("Dúvida sobre MockMvc", "Como faço para testar?", "Fulano de Tal", "Spring Boot");
    ...
    void cadastrar_cenario4_tituloEmBranco() throws Exception {
        // Arrange
        var dadosComTituloInvalido = new DtoCadastroTopico(
                "",
                "Mensagem válida",
                "Autor Válido",
                "Curso Válido"
    ...
    void cadastrar_cenario3() throws Exception {
        var dadosCadastro = new DtoCadastroTopico("Tópico Repetido", "Mensagem repetida.", "Ciclano", "Java");
    ...
    void listar_cenario3() throws Exception {
        // Arrange
        topicoRepository.save(new Topico(new DtoCadastroTopico("Tópico 1", "...", "Autor A", "Curso X")));
        topicoRepository.save(new Topico(new DtoCadastroTopico("Tópico 2", "...", "Autor B", "Curso Y")));
    ...
    void atualizar_cenario1() throws Exception {
        var topico = topicoRepository.save(new Topico(new DtoCadastroTopico(
                "Dúvida sobre Testes", "Como criar dados?", "Fulano de Tal", "Software"
        )));

        var dadosAtualizacao = new DtoAtualizacaoTopico(
                "Título Atualizado",
    ...
    void atualizar_cenario2() throws Exception {
        var dadosAtualizacao = new DtoAtualizacaoTopico("Título", "Mensagem", null);
    ...
    void atualizar_cenario3_outroUsuario() throws Exception {
        // Arrange
        var dadosCadastro = new DtoCadastroTopico("Tópico Original", "Minha mensagem", "Fulano de Tal", "Java");
        var topico = topicoRepository.save(new Topico(dadosCadastro));

        var dadosAtualizacao = new DtoAtualizacaoTopico("Título Inválido", "Mensagem Inválida", null);
    ...
    private Topico criarTopicoPadraoNoBanco() {
        var dados = new DtoCadastroTopico("Dúvida sobre Testes", "Como criar dados?", "Tester", "Software");
